...
public class InvoiceTest {
	...
	public void testEmptyInvoiceHasEmptyTaxAmount() {
		Assert.assertThat(BigDecimal.ZERO, Matchers.comparesEqualTo(invoice.getTaxPrice()));
	}
	...
	public void testInvoiceHasProperTaxValueForManyProduct() {
		...
		Assert.assertThat(new BigDecimal("10.30"), Matchers.comparesEqualTo(invoice.getTaxPrice()));
	}
